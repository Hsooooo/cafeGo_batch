...
DAEMONCLASS=co.kr.istarbucks.xo.batch.main.SamsungOrderAutoPushSender
DAEMONNAME=SamsungOrderAutoPushSender

DAEMONARGS1=$1

CONSOLEFILE=$LOG/SamsungOrderAutoPushSender_console.log
