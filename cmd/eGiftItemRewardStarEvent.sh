...
DAEMONCLASS=co.kr.istarbucks.xo.batch.egiftitem.EGiftItemRewardStar
DAEMONNAME=EGiftItemRewardStarEvent

CONSOLEFILE=$LOG/eGiftItemRewardStarEvent_console.log
...
if [ $# -le 1 ]; then
	...
	echo "USAGE : eGiftItemRewardStarEvent.sh"
fi
